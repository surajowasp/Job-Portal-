...
<div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>
            Welcome to Job Finder, your trusted partner in career discovery. We specialize in connecting talented individuals with top employers, making job searches seamless and efficient. Whether you're a job seeker looking for your dream job or an employer searching for the perfect candidate, we provide tailored solutions to meet your needs. Our platform features a wide range of opportunities across various industries, ensuring you find the right match. Join us at Job Finder and take the next step towards your future today!
            </p>
          </div>
        </div>
      </div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2024 <a href="learningfromscratch.online">Job Portal</a>.</strong> All rights reserved.
    </div>
  </footer>
...
<!-- Custom JavaScript for logout confirmation -->
<script>
