                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Kathmandu"><i class="fa fa-circle-o text-yellow"></i> Kathmandu</a></li>
                      <li><a href="" class="citySearch" data-target="Pokhara"><i class="fa fa-circle-o text-yellow"></i>Pokhara</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
